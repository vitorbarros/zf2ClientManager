 ...
 */
class Role extends \Client\Entity\Role implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Client\\Entity\\Role' . "\0" . 'roleId', '' . "\0" . 'Client\\Entity\\Role' . "\0" . 'roleName', '' . "\0" . 'Client\\Entity\\Role' . "\0" . 'roleCreatedAt', '' . "\0" . 'Client\\Entity\\Role' . "\0" . 'roleUpdatedAt'];
        }
    ...
    public function getRoleCreatedAt()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getRoleCreatedAt', []);

        return parent::getRoleCreatedAt();
    }
    ...
    public function getRoleUpdatedAt()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getRoleUpdatedAt', []);

        return parent::getRoleUpdatedAt();
    }
    ...
    public function setRoleUpdatedAt()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setRoleUpdatedAt', []);

        return parent::setRoleUpdatedAt();
    }
