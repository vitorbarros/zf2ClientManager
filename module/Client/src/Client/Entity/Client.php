...
class Client
{
    ...
    {
        return substr_replace(substr_replace(substr_replace($this->clientCpf, ".", 3, 0), ".", 7, 0), "-", 11, 0);
    }
    ...
    {
        $this->clientCpf = str_replace("-", "", str_replace("/", "", str_replace(".", "", $clientCpf)));
        return $this;
    }
    ...
    {
        return substr_replace(substr_replace(substr_replace(substr_replace($this->clientCnpj, ".", 2, 0), ".", 6, 0), "/", 10, 0), "-", 15, 0);
    }
    ...
    {
        $this->clientCnpj = str_replace("-", "", str_replace("/", "", str_replace(".", "", $clientCnpj)));
        return $this;
    }
